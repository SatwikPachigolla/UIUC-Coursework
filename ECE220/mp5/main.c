...
/* This is the main code for the program, which calls the functions in prog5.c */
int main ()
{
    char buf[200]; //Character array to get string from user
    int number; //Tracks guess number, game terminates after 7
    ...
    puts ("You failed to guess correctly in 5 guesses.\n");
